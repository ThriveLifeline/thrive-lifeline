...
## Workshop Series: Showing Up in Ways That Count

<center>

<img src="images/showing_up_workshop_announcement.png" alt="Blue background, text at top reads Spring 2024 workshop series. Centered is a box that says Showing Up in Ways That Count.Below reads highly discussion-based; training guide included! Sliding scale, March 31, April 7. Register today! Decorated with outline of hears and flowers, and 2 hands holding each other." 
style="width: 75%; height: 75%"/>

</center>

Stronger U and THRIVE Lifeline are partnering to offer a workshop series on community care that

 - radically changes approaches to wellness interventions and peer support
 - explores intentional ways to build safe spaces for various kinds of groups
 - depathologizes suicidality and invites non-carceral approaches to support
 - uplifts lived experience of chronic marginalization, complex trauma, and suicidality

[Register for the workshops today](https://form.jotform.com/240434317697158), or [learn more](thrivelifeline.org/workshops)!

 - Workshop 1: Creating Mental Health Safe Spaces on Sunday, May 5 at 7pm GMT / 3pm ET
 - Workshop 2: Creating Suicide Safe Conversations on Sunday, May 19 at 7pm GMT / 3pm ET
