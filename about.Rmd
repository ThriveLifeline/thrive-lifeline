...
marginalized identities. Among our services, we offer a free 
...
states, Puerto Rico, all Canadian provinces, and 37 additional 
countries worldwide.


We take a different approach. When you text THRIVE Lifeline, you can 
rest assured that our goal is to create the space you need to feel 
heard, valued, and uplifted. YOU, not your crisis, are at the center 
of our conversation. Our Crisis Responders all have at least one 
marginalized identity and are rigorously trained using our proprietary 
curriculum, taught by and for people with marginalized identities. We hope
that when you reach out to THRIVE you will talk to someone who gets it. 
...
early career professionals trained across the breadth of STEMM fields. We are 100% 
volunteer run and our volunteers are spread globally.
...
```{r, echo=FALSE, message=FALSE, fig.align="center", fig.cap="Barplot of the identities of the THRIVE Lifeline team. LGBTQ2S+ makes up 95%, women and non-binary makes up 75%, people of color make up 70%, people with disabilities make up 50%, and immigrants make up 15%."}
...
traits = data.frame(LGBTQ, POC, Disability, Trans, International, Immigrant)
...
barplot(traits_percentage,             ## Use percentage data
        ...
        ylab="Percentage",             ## Y-axis label
          ## Name the datasets; \n is a linebreak
        names.arg=c("LGBTQ2S+", "People of\nColor", "People with\nDisabilities", 
                    "Transgender", "International", "Immigrants"), 
...
<br>
Our backgrounds include familial rejection due to our identities, food and housing insecurity,
poverty, lack of access to education, immigration, and more. Many of us are 
individuals who have navigated accommodations processes during our academic 
journeys as a result of neurodivergence, living with disabilities, and/or facing trauma.
...
* Providing texters with free 24/7/365 hotline support by trained, non-judgmental
...
- **Donate**: Your donations of any size help to save and affirm lives. Currently we are are raising operational funds and funds to support our RECRUIT internship program. 
   - [**Donate today**](https://www.paypal.com/donate?hosted_button_id=CU5D6Q727QH5S) using our secure PayPal donation link.
