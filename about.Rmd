...
THRIVE Lifeline is a 501(c)(3) organization that began as a grassroots response 
to COVID-19. 
We are led by experienced crisis managers who personally understand the 
significance of displacement, isolation, and financial loss, especially for 
people in STEMM with marginalized identities.
...
<br/>
- **Donate**: We are currently raising $60,000 to purchase and integrate a
professional SMS platform that will allow us to increase our interaction volume 
while providing optimal service to our texters.
We are additionally seeking funds to certify 20 new suicide interveners in the
upcoming year.
   - [**Donate today**](https://www.paypal.com/donate?hosted_button_id=CU5D6Q727QH5S)).
<br> through our secure PayPal donation link.
