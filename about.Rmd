...
<!--, all Canadian provinces, and 37 additional 
countries worldwide.-->
...
curriculum, taught by and for people with intersecting marginalized identities. We hope
that when you reach out to THRIVE you will talk to someone who gets it. 

<br>

## Who Are We?
THRIVE Lifeline is Trans-led and operated. We are a 100% volunteer group of certified suicide interventionists whose identities are marginalized, and who are students, career professionals, and retirees largely trained across the breadth of STEMM fields
...
traits = data.frame(LGBTQ, POC, Disability, Trans, Immigrant)
