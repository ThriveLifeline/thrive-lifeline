			...
			<div class="card h-100">
			  <div class="card-body">
				  <div class="card-img">
					  ...
					  <p class="card-title">LGBTQ Flyer</p>
					</div>
					<div class="card-footer mx-auto">
					<a download="lgbtq-flyer.svg" href="images/gallery/lgbtq-flyer.svg" class="button"><i class="fas fa-download" aria-hidden="true"></i> Download</a>
